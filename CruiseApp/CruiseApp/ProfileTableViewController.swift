...
//        UIApplication.shared.openURL(NSURL(string: "https://www.snapchat.com/add/dictator28")! as URL)
    ...
    func Instagram(_ sender: Any) {
        guard let url = URL(string: "https://www.instagram.com/shivran_/") else { return }
        UIApplication.shared.open(url)
        
   //   UIApplication.shared.openURL(URL(string: "https://www.instagram.com/shivran_/")!)
    

//    UIApplication.shared.openURL(NSURL(string: "https://www.instagram.com/shivran_/")! as URL)
}
